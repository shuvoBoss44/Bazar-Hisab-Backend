...
class TransactionController {
  ...
  static async updateTransaction(req, res, next) {
    ...
    try {
      ...
      if (isNewBalanceAddition || isNewBalanceRemoval) {
      ...
      let userBalanceBeforeTransactionForCreator = 0;
      ...
      originalTransaction.userBalanceBeforeTransaction = userBalanceBeforeTransactionForCreator;
      originalTransaction.usersBalancesAtTransactionTime = usersBalancesAtTransactionTime;
